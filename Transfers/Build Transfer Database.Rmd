...
#### _TODO_
1.  Use charts to infer break points (top 10?)
2.  Build out input data base
3.  Add-in data for more months
...
output_file_string <- "M:/Data/Clipper/Transfers/From Anonymous/Transfers by day by agency pair.csv"
```
